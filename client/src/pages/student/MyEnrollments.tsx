...
const MyEnrollments = () => {
  const { enrolledCourses, calculateCourseDuration, navigate, userData, fetchUserEnrolledCourses, backendUrl, getToken, calculateTotalNoLectures } = useContext(AppContext)
    ...
    try {
      ...
      const tempProgressArray = await Promise.all(
        enrolledCourses.map(async (course) => {
          ...
          const totalLectures = calculateTotalNoLectures(course)
