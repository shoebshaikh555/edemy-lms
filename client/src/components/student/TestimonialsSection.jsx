...
const TestimonialsSection = () => {
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <p className="md:text-base text-gray-500 mt-3">Hear from our learners as they share their journeys of transformation, success and how our <br /> platform hs made difference in their lives</p>
